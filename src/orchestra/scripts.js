...
export const VOICES = [
  ...
  { file: '/chamber/voices/guide-03.mp3',        time: 345, duck: true, azimuth: 0,   elevation: 70,  distance: 2.0, gain: 2.3, category: 'guide' },  // "Above you." — overhead (gain reduced: 2m not 3m)
  { file: '/chamber/voices/guide-04.mp3',        time: 348, duck: true, azimuth: 0,   elevation: -40, distance: 2.0, gain: 2.3, category: 'guide' },  // "Below you." — below (gain reduced: 2m not 3m)
  { file: '/chamber/voices/guide-05.mp3',        time: 355, duck: true, azimuth: 0,   elevation: 0,   distance: 0.3, gain: 0.7, category: 'guide' },  // "Inside." — inside the head (gain greatly reduced: 0.3m)
  ...
  { file: '/chamber/voices/guide-06.mp3',        time: 495, duck: false, azimuth: 90,  elevation: 20, distance: 4.0, gain: 4.5, category: 'guide' },  // "Let go." — drifting away (gain up: 4m)
  { file: '/chamber/voices/witness-04.mp3',      time: 515, duck: false, azimuth: 220, elevation: 30, distance: 5.0, category: 'witness' },
  { file: '/chamber/voices/guide-07.mp3',        time: 530, duck: false, azimuth: 0,   elevation: 5,  distance: 1.0, gain: 1.5, category: 'guide' },  // "Good." — intimate, close (gain reduced: 1m)
]
