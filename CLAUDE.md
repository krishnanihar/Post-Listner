...
- `docs/superpowers/specs/2026-06-09-slice5-longitudinal-mechanics-design.md` + `docs/superpowers/plans/2026-06-09-slice5-longitudinal-mechanics.md` — **Slice 5 (longitudinal mechanics)**, built: `src/lib/longitudinal.js` (days-of-practice + Bilderatlas milestone/unlock/anniversary engine) + the quiet `Settle.jsx` surface. Deferred: Orchestra cadence (C1, reversible bet) + the Bilderatlas moment UI (C4.4, asset-blocked). Next: **Slice 6 — ship-blocker hardening**.
