...
- `docs/superpowers/specs/2026-06-09-slice4-local-first-archive-design.md` + `docs/superpowers/plans/2026-06-09-slice4-local-first-archive.md` — **Slice 4 (local-first IndexedDB archive)**, built: `archive.js`/`sessionRecord.js`/`avdRecorder.js`, `sessionStore` re-backed by a hydrate cache (hydrate-before-render), one-time localStorage migration, dev export/erase. Coexists with Supabase (decision ②a). Next: **Slice 5 — longitudinal mechanics**.
