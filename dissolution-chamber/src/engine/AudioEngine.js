...
export default class AudioEngine {
  ...
  init(collectiveAVD) {
    ...
    // Start the pre-generated collective track (looping, gain-controlled by phase)
    const collectiveBuffer = this.buffers.get('/music/collectiveend.mp3');
    if (collectiveBuffer) {
      this.collective.playTrack(collectiveBuffer);
    }
